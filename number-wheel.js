define(['constants', 'canvasclippingnode'], function(constants, CanvasClippingNode) {
	...
	var NumberWheel = cc.Node.extend({
		...
		ctor:function(numberOfDigits) {
			...
			var background = new cc.Sprite.create(window.bl.getResource('number_wheel_nw_' + numberOfDigits + "_ov"));
			...
			for (var i = 0; i < numberOfDigits; i++) {
				...
				var sectionBackground = new cc.Sprite.create(window.bl.getResource('number_wheel_numberwheelsectionbackground'));
